...
import * as employeeStore from "./employee/reducers";
import * as companyStore from "./company/reducers";
...
@NgModule({
  ...
  imports: [
    ...
    StoreModule.forRoot(employeeStore.ROOT_REDUCERS, {
      metaReducers,
      runtimeChecks: {
    ...
    StoreModule.forRoot(companyStore.ROOT_REDUCERS, {
      metaReducers,
      runtimeChecks: {
        strictStateSerializability: true,
        strictActionSerializability: true,
